...
# Populate a category with CategoryItem for testing
# Using different users for CategoryItem also
Item1 = CategoryItem(name="Football Boots",
...
Item2 = CategoryItem(name="Football Shirt",
...
Item3 = CategoryItem(name="Football",
